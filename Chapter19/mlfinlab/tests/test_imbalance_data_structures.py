...
class TestDataStructures(unittest.TestCase):
    ...
    def test_imbalance_dollar_bars_additional_features(self):
        """
        ...
        # Act
        db = ds.get_dollar_imbalance_bars(self.path, exp_num_ticks_init=exp_num_ticks_init, num_prev_bars=num_prev_bars, batch_size=1000, verbose=False,
    ...
    def test_imbalance_volume_bars_additional_features(self):
        """
        ...
        # Act
        vb = ds.get_volume_imbalance_bars(self.path, exp_num_ticks_init=exp_num_ticks_init, num_prev_bars=num_prev_bars, batch_size=1000, verbose=False,
             additional_features= [high_over_low, low_over_high])
    ...
    def test_imbalance_tick_bars_additional_features(self):
        """
        ...
        # Act
        tb = ds.get_tick_imbalance_bars(self.path, exp_num_ticks_init=exp_num_ticks_init, num_prev_bars=num_prev_bars, batch_size=1000, verbose=False,
             additional_features= [high_over_low, low_over_high])
