...
class CLAModified:
    ...
    def _initialise(self, asset_prices, covariance):
    ...
    def allocate(self, asset_prices, covariance, solution="cla_turning_points"):
        '''
        ...
        self._initialise(asset_prices=asset_prices, covariance=covariance)
